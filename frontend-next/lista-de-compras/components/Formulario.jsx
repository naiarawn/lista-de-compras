  ...
  <div className={styles.container}>
    <form onSubmit={sendData} action="" className={styles.container}>
      <div className={styles.inputBox}>
        ...
        <input type="text" id='name' name='name'onChange={onChangeInput} value={dataForm.name} placeholder="Lorem ipsum"/>
      </div>
      <div className={styles.agrupa}>
        <div className={styles.inputBox}>
          <label htmlFor="priority">Prioridade de compra</label>
          <input type="text" id='priority' name='priority'onChange={onChangeInput} value={dataForm.priority} placeholder="Lorem ipsum"/>     
        </div>
        <div className={styles.inputBox}>
          <label htmlFor="price">Preço do Produto</label>
          <input type="number" id='price' name='price'onChange={onChangeInput} value={dataForm.price} placeholder=" R$23,00"/>  
        </div> 
      </div>
      <div className={styles.inputBox}>
        <label htmlFor="whereToBuy">Onde comprar</label>
        <input type="text" id='whereToBuy' name='whereToBuy'onChange={onChangeInput} value={dataForm.whereToBuy} placeholder="Lorem ipsum"/>  
      </div> 
      <div className={styles.inputBox}>
